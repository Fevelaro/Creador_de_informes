...
En cuanto a las corrientes, mostradas en el Cuadro \ref{tab:alimentadores}, se debe considerar: La corriente de la fase R corresponde a un \VAR{Capacidad_corriente_FaseR} de la máxima soportada por diseño, la de la fase S corresponde a un \VAR{Capacidad_corriente_FaseS} de la máxima soportada por diseño y la de la fase T corresponde a un \VAR{Capacidad_corriente_FaseR} de la máxima soportada por diseño.
...
\begin{center}
    \begin{table}[H]
        ...
        \begin{tabular}{c | c c c | c c c | c c c}
            ...
            %%%Agregar for o alguna manera de adaptarlo según cantidad de datos. pensar en esto.
